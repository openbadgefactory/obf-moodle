...
$string['apidataretrieveall'] = 'Kaikki';
$string['apidataretrievelocal'] = 'Tapahtumat tästä järjestelmästä';
$string['apidataretrieve'] = 'Tapahtumien noutaminen';
...
$string['backpackconfig'] = 'Backpack-asetukset';

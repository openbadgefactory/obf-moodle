...
//                $ret[$courseid] = self::get_empty_coursedata();
//                $ret[$courseid]->id = $courseid;
//            }
//
...
//    }
    ...
    public static function get_empty_coursedata() {
        $obj = new stdClass();
...
//    public static function customizeform(obf_criterion_form &$form) {
//        global $DB, $OUTPUT;
//
//        $mform = $form->get_form();
//        $criterionid = $form->get_criterion()->get_id();
//
...
//                $courselist = self::initialize_categories($categories);
//
//                foreach ($courses as $course) {
...
//                self::add_coursefields($mform, $courseid, $coursedata);
//            }
//
...
//    }
//
//    public static function add_coursefields(&$mform, $courseid, $coursedata) {
//
//        // Minimum grade -field
...
//    private static function initialize_categories(array $categories) {
//        $courselist = array();
//
//        // initialize categories for the select list's optgroups
//        foreach ($categories as $category) {

...
class local_obf_assertion_collection_testcase extends advanced_testcase {
    ...
    public function test_collection() {        
        ...
        $badge1 = obf_badge::get_instance()->set_image('image1')->set_description($description)->set_issuer($issuer);
        $badge2 = obf_badge::get_instance()->set_image('image2')->set_description($description)->set_issuer($issuer);
        $badge3 = obf_badge::get_instance()->set_image('image3')->set_description($description)->set_issuer($issuer);
        $badge4 = obf_badge::get_instance()->set_image('image4')->set_description($description)->set_issuer($issuer);
